...
let seekreset = e=>getsuara().setCurTime(0)
let speedreset = e=>getsuara().setspeed(1)
...
que('#showseek'	)[0].addEventListener('dblclick'	,seekreset	,);		que('#showseek')[0].textContent = '----'
que('#showspeed'	)[0].addEventListener('dblclick'	,speedreset	,);		que('#showspeed')[0].textContent = '----'
...
`Selamat datang di Poly Landhep v4.2, silakan -->> DOUBLECLICK <<-- info ini (expand & collapse)
